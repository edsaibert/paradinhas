...
public class Jogador implements Serializable{
	...
	public void setFillJogador(ImageViewSerialize ImageViewSerialize){
		switch (id){
			case 0:
	...
	public Jogador(int id){
		...
		this.indicador.setAll();
		this.posicaoJogador.setAll();
	}

	public void setIndicador(){
		this.indicador.setX(this.indicador.x);
		this.indicador.setY(this.indicador.y);
		this.indicador.setVisible(this.indicador.visible);
		this.indicador.setImage(new Image("application/assets/players/setaE4.png"));
	}

	public void setPosicao(){
		int x = this.posicaoJogador.x;
		int y = this.posicaoJogador.y;
		int width = this.posicaoJogador.width;
		int height = this.posicaoJogador.height;
